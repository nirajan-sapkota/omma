<?php $__env->startSection('title', 'Complete Payment — Omma Health Center'); ?>
        ...
        <div class="payment-layout">
            ...
            <div class="pay-card">
                <div class="pay-card-title">
                    <h2><?php echo e($paymentSetting->title ?? 'Fonepay / eSewa Payment QR'); ?></h2>
                    <span class="amount-badge">
                        <?php echo e($paymentSetting->amount ?? 'NPR 1,000'); ?>
                ...
                <div class="qr-container">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($paymentSetting && $paymentSetting->image_url): ?>
                        <img
                            src="<?php echo e($paymentSetting->image_url); ?>"
                            alt="Payment QR Code"
                            class="qr-img"
                        >
                        <div style="margin-top: 10px;">
                            <a href="<?php echo e($paymentSetting->image_url); ?>" target="_blank" style="color: var(--pay-primary); font-size: 12px; font-weight: 700; text-decoration: none;">
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($paymentSetting && ($paymentSetting->account_name || $paymentSetting->account_number)): ?>
                    <div class="account-info-grid">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($paymentSetting->account_name): ?>
                            <div class="account-info-item">
                                <small>ACCOUNT NAME</small>
                                <strong><?php echo e($paymentSetting->account_name); ?></strong>
                            </div>
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>

                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($paymentSetting->account_number): ?>
                            <div class="account-info-item">
                                <small>ACCOUNT / PHONE NO.</small>
                                <strong><?php echo e($paymentSetting->account_number); ?></strong>
                            </div>
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    </div>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            ...
            <div class="pay-card">
                ...
                <div class="summary-mini">
                    <div class="summary-mini-item">
                        ...
                        <span class="summary-mini-val"><?php echo e($serviceName); ?></span>
                    </div>
                    <div class="summary-mini-item">
                        <span class="summary-mini-label">Type</span>
                        <span class="summary-mini-val">
                            <?php echo e($draft['category'] === 'online' ? '🎥 Online' : '📍 In-Person'); ?>
                    ...
                    <div class="summary-mini-item">
                        ...
                        <span class="summary-mini-val">
                            <?php echo e(\Carbon\Carbon::parse($draft['appointment_date'])->format('D, M j, Y')); ?>
                    ...
                    <div class="summary-mini-item">
                        ...
                        <span class="summary-mini-val">
                            <?php echo e(\Carbon\Carbon::parse($draft['appointment_time'])->format('g:i A')); ?>
                ...
                <form
                    action="<?php echo e(route('booking.confirm')); ?>"
                    method="POST"
                ...
                >
                    ...
                    <div style="text-align: center;">
                        <a href="<?php echo e(route('booking.create')); ?>" class="back-link">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\omma-health-center\resources\views/payment.blade.php ENDPATH**/ ?>
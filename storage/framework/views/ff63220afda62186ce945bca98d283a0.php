...
<section class="booking-page">
    ...
    <div class="booking-container">
        ...
        <form
            method="POST"
            action="<?php echo e(route('booking.store')); ?>"
            id="booking-form"
        >
...
<?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(old('category', 'online') === 'online'): ?>
    ...
    <div class="google-connect-box">
        ...
        <div class="google-connect-content">
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(session('google_token')): ?>
            ...
            <?php else: ?>
                ...
                <a
                    href="<?php echo e(route('google.connect')); ?>"
...
<?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        ...
                        <div class="appointment-options">
                            ...
                            <input
                                ...
                                class="hidden-radio"
                                required
                                <?php echo e(old('category', 'online') === 'online'
                                    ? 'checked'
                                    : ''); ?>
                            ...
                            <input
                                ...
                                value="physical"
                                class="hidden-radio"
                                <?php echo e(old('category') === 'physical'
                                    ? 'checked'
                                    : ''); ?>
                        ...
                        <div class="date-grid">
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php for($i = 0; $i < 14; $i++): ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                ...
                                <input
                                    ...
                                    id="date-<?php echo e($i); ?>"
                                    value="<?php echo e($date); ?>"
                                    class="hidden-radio"
                                    required
                                    data-date="<?php echo e($date); ?>"

                                    <?php echo e(old('appointment_date') === $date ||
                                ...
                                >
                                    ...
                                    <span class="date-number">
                                        <?php echo e($d->format('j')); ?>

                                    </span>

                                    <span class="date-month">
                                        <?php echo e($d->format('M')); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\omma-health-center\resources\views/booking.blade.php ENDPATH**/ ?>